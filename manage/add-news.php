...
if (isset($_POST['submit'])){
    ...
    $user_name="root";
        ...
        $query="insert into news (title,text,picturs,date)values('$title','$text','$date','$filename')";
...
<html lang="en">
  ...
  <body>
    <div id="panel" class="panel">
      ...
      <div class="afzodan">
        <div class="text"> <span>محتویات خود را به اخبار سایت اضافه کنید.</span></div>
        <div class="inputha">
        <div class="g-input">
