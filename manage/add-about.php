...
if (isset($_POST['submit'])){
    ...
    $user_name="root";
        ...
        $query="insert into about (info,text,picturs)values('$info','$text','$filename')";
...
<html lang="en">
  ...
  <body>
    <div id="panel" class="panel">
      ...
      <div class="afzodan">
        <div class="text"> <span>محتویات خود را به درباره ما اضافه کنید.</span></div>
        <div class="inputha">
        <div class="g-input">
