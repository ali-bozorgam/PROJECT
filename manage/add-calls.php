...
if (isset($_POST['submit'])){
    ...
    $user_name="root";
        ...
        $query="insert into calls (tel,email,picturs,telegram)values('$tel','$email','$filename','$telegram')";
...
<html lang="en">
  ...
  <body>
    <div id="panel" class="panel">
      ...
      <div class="afzodan">
        <div class="text"> <span>محتویات را به تماس سایت اضافه کنید.</span></div>
        <div class="inputha">
        <div class="g-input">
