...
<html lang="en">
  ...
  <body>
    <div id="panel" class="panel">
      ...
      <div id="left">
       ...
       <div style="width:16%;float: right;border: 1px solid white;box-shadow: inset 7px 0 10px rgba(114, 114, 114, 0.6);color:white;text-align: center;padding: 5px 0px"><span>ایمیل </span></div>
       ...
       <div style="width:14%;float: right;border: 1px solid white;box-shadow: inset 7px 0 10px rgba(114, 114, 114, 0.6);color:white;text-align: center;padding: 5px 0px"><span>تلگرام</span></div>
  ...
  $m--;
  $m=$m*8;
  $query="select * from calls limit $m,8";
  ...
  while ($record=mysqli_fetch_array($result)){
      ...
      <div style="width:14%;float: right;border: 1px solid white;box-shadow: inset 7px 0 10px rgba(114, 114, 114, 0.6);color:white;text-align: center;padding: 5px 0px;color:#333"><span>'.$record['tel'].' </span></div>
      <div style="width:16%;float: right;border: 1px solid white;box-shadow: inset 7px 0 10px rgba(114, 114, 114, 0.6);color:white;text-align: center;padding: 5px 0px;color:#333"><span>'.$record['email'].' </span></div>
      ...
      <div style="width:14%;float: right;border: 1px solid white;box-shadow: inset 7px 0 10px rgba(114, 114, 114, 0.6);color:white;text-align: center;padding: 5px 0px;color:#333"><span>'.$record['telegram'].'</span></div>
      <div style="width:14%;float: right;border: 1px solid white;box-shadow: inset 7px 0 10px rgba(114, 114, 114, 0.6);color:white;text-align: center;padding: 5px 0px;color:#333"><a href="del-calls.php?id='.$record['id'].'"><span>حذف</span></a></div>
      <div style="width:14%;float: right;border: 1px solid white;box-shadow: inset 7px 0 10px rgba(114, 114, 114, 0.6);color:white;text-align: center;padding: 5px 0px;color:#333"><a href="ed-calls.php?id='.$record['id'].'"><span>ویرایش</span></a></div>
...
<?php
        ...
        $count=ceil($count/8);
        for ($i=1;$i<=$count;$i++){
            echo '<div style="width: 6%;float: right;background: #ccc;margin-right: 5px;margin-top: 5px; border-radius: 10px;text-align: center;font-size: 1.1em;  padding-top: 2px; color: red"><a href="?m='.$i.'">'.$i.'</a></div>';
        }
        ?>
