...
if (isset($_POST['submit'])){
    ...
    $uploadir='../images/uploads/product/';
    ...
    $user_name="root";
        ...
        $query="insert into product (title,type,price,comment,picturs)values('$title','$type','$price','$comment','$filename')";
...
<html lang="en">
  ...
  <body>
    <div id="panel" class="panel">
      ...
      <div class="afzodan">
        <div class="text"> <span>محتویات خود را به محصولات اضافه کنید.</span></div>
        <div class="inputha">
        <div class="g-input">
